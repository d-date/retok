...
A CLI tool that analyzes your Claude Code usage logs (transcripts) to measure **token efficiency**, estimate cost, and print actionable recommendations.

Runs on Python 3 with the standard library only — no dependencies.

```
══════════════════════════════════════════════════════════════════════════
  retok — Claude Code Token Efficiency Report (last 30 days / 464 files)
══════════════════════════════════════════════════════════════════════════

■ Overview
  Estimated cost            $2,072.21
  Cache hit rate            89.3%
  Cost per prompt           $1.588
  ...
